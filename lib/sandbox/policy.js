 ...
 * @param {string[]} [opts.customWritablePaths]  用户自定义的额外可写路径
 * @returns {object} policy
 */
export function deriveSandboxPolicy({ agentDir, workspace, workspaceFolders = [], hanakoHome, mode, customWritablePaths = [] }) {
  if (mode === "full-access") {
